CREATE TABLE [dbo].[tblCallsBilledArchive] (
...
CREATE NONCLUSTERED INDEX [ind_recordID]
    ON [dbo].[tblCallsBilledArchive]([RecordID] ASC);


GO
CREATE NONCLUSTERED INDEX [ind_folder]
    ON [dbo].[tblCallsBilledArchive]([AgentID] ASC, [FolderDate] ASC, [InRecordFile] ASC);
