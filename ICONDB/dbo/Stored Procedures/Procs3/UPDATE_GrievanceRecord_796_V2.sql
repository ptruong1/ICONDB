...
CREATE PROCEDURE [dbo].[UPDATE_GrievanceRecord_796_V2]
(
	 @FacilityId int
	,@formID int
	,@InmateID Varchar(12)
	...
	,@Category Varchar(25)
      ...
      ,@ThirdAppeal varchar(200)
	  ,@AppealCommanderSignature varchar(50)
	  ,@AppealCommanderTime varchar(50)
      
      ,@OfficerLastStatement varchar(200)
	  
	 
	  ,@InmateLastStatement varchar(200)
