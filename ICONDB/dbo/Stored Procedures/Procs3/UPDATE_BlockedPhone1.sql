...
CREATE PROCEDURE [dbo].[UPDATE_BlockedPhone1]
(
	@PhoneNo char(10),
	@FacilityID int,
	@ReasonID tinyint,
...
ELSE
	BEGIN
		UPDATE [tblBlockedPhones] SET [PhoneNo] = @PhoneNo, ReasonID=@ReasonID, [Username] = @Username, [RequestID] = @RequestID, [TimeLimited]=@TimeLimited
