...
CREATE PROCEDURE [dbo].[UPDATE_InmateByPIN2]
(
	@PIN bigint,
	@InmateID bigint,
	@LastName varchar(25),
...
ELSE
	BEGIN
		UPDATE [tblInmate] SET [InmateID] = @InmateID, [LastName] = @LastName, [FirstName] = @FirstName, [MidName] = @MidName, 
				...
				[MaxCallPerHour] = @MaxCallPerHour, [MaxCallPerDay] = @MaxCallPerDay, [MaxCallPerWeek] = @MaxCallPerWeek, [MaxCallPerMonth] = @MaxCallPerMonth, [TTY] = @TTY
