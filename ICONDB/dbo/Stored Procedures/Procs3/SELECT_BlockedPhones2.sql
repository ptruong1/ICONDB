...
CREATE PROCEDURE [dbo].[SELECT_BlockedPhones2]
(
	@FacilityID int
)
AS
...
IF (@FacilityID = 1 Or @FacilityID = 2  or  @FacilityID  = 0)
	BEGIN
		SELECT  PhoneNo, FacilityID, Username, A.ReasonID, T.Description as [Description], InputDate, R.Descript as [RequestReason], TimeLimited, A.Descript as [Note]
