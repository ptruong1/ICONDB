...
-- =============================================
CREATE PROCEDURE [dbo].[SELECT_InmateByInmateID_020414]
(
	@InmateID varchar(12),
	@FacilityId int
)
...
SELECT       PIN, I.InmateID, LastName, FirstName, MidName, Status as StatusID, S.Descipt as [StatusDesc], DNIRestrict, DateTimeRestrict, AlertEmail, AlertCellPhones, AlertPhone, DNILimit, I.FacilityId,
			 MaxCallTime,HourlyFreq,DailyFreq,WeeklyFreq,MonthlyFreq, I.inputdate, UserName, I.ModifyDate, MaxCallPerHour, MaxCallPerDay, MaxCallPerWeek, MaxCallPerMonth, isnull(TTY,'0') as TTY,
			isnull(DebitCardOpt,'0') as DebitCardOpt, isnull(NameRecorded,'0') as NameRecorded, isnull(StartDate,getdate()) as StartDate, isnull(EndDate,getdate()) as EndDate, DOB, Sex, I.InputDate, AccessType,
...
WHERE I.InmateID = @InmateID AND  I.FacilityId = @FacilityId
