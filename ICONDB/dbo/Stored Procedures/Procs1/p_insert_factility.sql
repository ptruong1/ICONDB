...
CREATE PROCEDURE [dbo].[p_insert_factility]
(
...
ELSE
	BEGIN
		...
		set           @ID = @nextID ; 
		INSERT INTO [tblFacility] ([FacilityID] ,[Location], [Address], [City], [State], [Phone], [Zipcode], [ContactName], [ContactPhone], [ContactEmail], [IPaddress], [logo], [AgentID], [RateplanID], 
...
VALUES
		...
		(@ID, @Location, @Address, @City, @State, @Phone, @ZipCode, @ContactName, @ContactPhone, @ContactEmail, @IPaddress, @logo, @AgentID, @RateplanID,
