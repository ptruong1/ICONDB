create PROCEDURE [dbo].[p_Chart_Agent_LiveCommunication3]
@AgentID  int
...
(case when @AgentId > 1 then @Test 
  ...
  (select count(*) from [172.77.10.22\bigdaddyicon].[Leg_LiveCast].[dbo].tblOnlineAllACPs where AgentID = @AgentID and Status = 'Active') 
