...
CREATE PROCEDURE [dbo].[p_INSERT_RecordingListTrans_06212018]
(
...
SET @count = 0;
SELECT @count = COUNT(*) FROM [tblRecordingTranscript_851] WHERE Username = @UserName AND TranscriptName = @TranscriptName;
IF @count > 0
	RETURN -1;
ELSE
BEGIN
    ...
    set           @ID = @nextID ;    
	INSERT INTO [tblRecordingTranscript_851] ([TranscriptListID] ,[TranscriptName], [UserName], Words) 
