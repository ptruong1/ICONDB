CREATE PROCEDURE [dbo].[p_get_billtype_web_service2]
@ANI	char(10),
@DNI	varchar(16),
...
--- Check for Free Phones	
	...
	---------------Hardcode for Free ------------
	--if(@facilityID= 765 and @localtime > '2016-10-05 12:00:00.000' and  @localtime < '2016-10-05 16:00:00.000' )
	--	SET @Billtype ='08';

	--if(@facilityID= 691 and @localtime > '2016-10-05 09:00:00.000' and  @localtime < '2016-10-05 16:00:00.000' )
	--	SET @Billtype ='08';
			 ...
			 begin
				...
				If(@balance =-1)
				 Begin
					...
					Return -1;
				 End	
				Else If(@balance <@Minbilled or @balance <=0)
				 Begin
