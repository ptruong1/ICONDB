CREATE PROCEDURE [dbo].[p_insert_email_message_v2]  -- Family send Email to Inmate Email Box
...
Begin
	...
	INSERT tblMailboxDetail(MailBoxID ,  messageID,  MessengerNo, MessageDate , MessageName    ,  IsNew, [message], MessageTypeID,SenderMailBoxID, CCEmails, Charge,MessageStatus, MonitorOpt, DeviceName )
				values(@MailBoxID, @messageID, @AccountNo,@LocalTime,@messageName,1, @Message,2, @FFMailBoxID,@CCEmails,@Charge,@MessageStatus, @MonOpt, @DeviceName);
