...
Create PROCEDURE [dbo].[p_create_user_05232018]
@UserID varchar(20),  
@Password  varchar(20),
@FacilityID int ,
@AgentID  int,
...
Insert tblUserprofiles (UserID , Password, FacilityID , AgentID, LastName ,  FirstName ,  MidName ,ID,  Department , authID, Phone , Email, userLevel, Createdby, IPaddress, SecondFactor) 
values(@UserID,@password  , @FacilityID , @AgentID , @LastName  ,@FirstName   ,@MidName  , @ID, @Department  , @authID, @Phone  ,@Email,  @userLevel ,@Createby,@IPaddress,@SecondFactor);
