...
CREATE PROCEDURE [dbo].[p_INSERT_PAN_07122018]
(
	@InmateID varchar(12),
	@PAN varchar(15),
	@PIN varchar(12),
...
ELSE
	BEGIN
		...
		if (SELECT count(phoneNo) FROM tblPhones WHERE InmateID = @InmateID and facilityID = @facilityID) = (SELECT DNILimit  FROM tblInmate WHERE FacilityID = @FacilityId  and InmateID = @InmateID and Status=1) 
		begin 
