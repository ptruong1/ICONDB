...
CREATE PROCEDURE [dbo].[p_create_debit_account_with_inmate]
@facilityID	int,
@InmateID	Varchar(12),
...
if(@AccountNo='0')
 ...
 End
Else
    Update [tblDebit] SET Balance = balance + @balance, status=1, modifyDate= GETDATE() where AccountNo = @AccountNo;
