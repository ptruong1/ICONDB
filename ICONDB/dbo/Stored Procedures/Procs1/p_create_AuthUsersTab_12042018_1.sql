...
create PROCEDURE [dbo].[p_create_AuthUsersTab_12042018_1]
(
	@AuthID bigint,
	@Layout bit,
	@Config bit,
...
INSERT [tblAuthUserTab] ([AuthID],[CreateUser],[ListUser],[SearchUser],[ActivityUser],[OfficerActivity],[UserGroups])
	VALUES (@AuthID, @CreateUser, @ListUser, @SearchUser, @ActivityUser, @OfficerActivity,@UserGroups)
