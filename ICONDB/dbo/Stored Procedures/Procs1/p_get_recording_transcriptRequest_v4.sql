...
CREATE PROCEDURE [dbo].[p_get_recording_transcriptRequest_v4]
...
words, TranscriptionName, '' CalleeText, '' CallerText, '' WordsMatch, '-Out.wav' as Extension
from #temp 
...
words, TranscriptionName, '' CalleeText, '' CallerText, '' WordsMatch, '-In.wav' as Extension
from #temp )
order by Extension;
