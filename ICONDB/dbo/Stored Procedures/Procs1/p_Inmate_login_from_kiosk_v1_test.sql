...
-- =============================================
CREATE PROCEDURE [dbo].[p_Inmate_login_from_kiosk_v1_test] 
...
BEGIN
   ...
   If(@facilityID> 0)
    begin
		...
		if(@inmateID <> '0')
		 begin
			...
			else --- New edit 8/11/16
			 begin
				if((@facilityID = 578 ) and (@locationID <> @InmateLocationID) )
				 begin
					SET @inmateID ='0';
					SET @InmateName='';
					SET @InmateSO ='';
    ...
    @FormOpt as  FormOpt, @MedicalKiteForm as MedicalKiteForm, @InmateKiteForm  as InmateKiteForm , @GrievanceForm as  GrievanceForm, @MedicalKiteReceiveEmail as  MedicalKiteReceiveEmail , @InmateKiteReceiveEmail as InmateKiteReceiveEmail, @GrievanceReceiveEmail as  GrievanceReceiveEmail, @timeDiff as TimeDiff, @MedProvider as  MedProvider, @FacilityName as FacilityName;
