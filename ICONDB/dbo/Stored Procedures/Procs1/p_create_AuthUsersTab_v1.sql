...
CREATE PROCEDURE [dbo].[p_create_AuthUsersTab_v1]
(
	@AuthID bigint,
	@FacilityConfig  bit,
	@UserControl bit, 
...
insert tblAuthUsers(AuthID, FacilityConfig, UserControl, PhoneConfig, CallControl ,DebitCard ,InmateProfile ,Report, CallMonitor ,Messaging, VideoVisit, ServiceRequest,Kites ,MyReport,[Admin],PowerUser,[Finance-Auditor],Investigator,DataEntry,UserDefine)
		   values(@AuthID, @FacilityConfig, @UserControl, @PhoneConfig, @CallControl ,@DebitCard ,@InmateProfile ,@Reports, @CallMonitor ,@Messaging,@VideoVisit, @ServiceRequest,@Kites, @MyReport,0,0,0,0,0,1);
