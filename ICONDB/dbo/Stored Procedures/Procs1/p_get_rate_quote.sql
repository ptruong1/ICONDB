...
Declare @pointID	varchar(2), @TotalSurcharge  numeric(4,2) , @libCode varchar(2), @LECCall char(2), @countryCode varchar(3);
...
Select @countryCode = countrycode from tblprepaid where PhoneNo =@AccountNo and FacilityID = @FacilityID 
