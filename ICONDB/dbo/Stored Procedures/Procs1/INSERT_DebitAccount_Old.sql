...
CREATE PROCEDURE [dbo].[INSERT_DebitAccount_Old]
(
	@InmateID varchar(12),
	@FacilityID int,
...
begin
	...
	If(@Balance >=0)
		INSERT INTO tblDebitpayments(AccountNo,  InmateID ,   FacilityID,  Amount  ,     PaymentTypeID, CheckNo  ,   CCNo   ,          CCExp, CCzip ,CCcode ,UserName   , CCFirstName  ,  CCLastName,    PaymentDate   , Note )
		Values  (@AccountNo, @InmateID, @facilityID, @Balance ,  @paymentTypeID, @checkNo	, @ccNo	, @ccExp,@ccZip, @ccCVV	, @UserName, @ccFirstName	, @ccLastName,  getdate(), @Note)
