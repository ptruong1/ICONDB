...
-- =============================================
CREATE PROCEDURE [dbo].[p_get_Inactive_Inmate_list_06192017]
AS
BEGIN
	...
	SELECT  I.FacilityID, I.InmateID, I.PIN, 
	 Case when I.PrimaryLanguage < 2 then (Cast(I.FacilityID AS VARCHAR(4)) + '-' + I.PIN) else (Cast(I.FacilityID AS VARCHAR(4)) + '-' + I.InmateID) end  UserID, 
