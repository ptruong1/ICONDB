CREATE PROCEDURE [dbo].[INSERT_Inmate6]
(
	@InmateID varchar(12),
	@MinLength		tinyint,
	@LastName varchar(25),
...
ELSE
	BEGIN
		...
		INSERT INTO [tblInmate] ([InmateID], [LastName], [FirstName], [MidName], 
					...
					AssignToDivision, AssignToLocation, AssignToStation, CustodialOpt, DOB, SEX, RaceID, AdminNote, InmateNote,ActiveDate) 
		...
		EXEC  INSERT_ActivityLogs3	@FacilityID ,10,@ActiveDate  ,0,@UserName ,'', 0,@UserAction ;  
		RETURN 0;
	END
