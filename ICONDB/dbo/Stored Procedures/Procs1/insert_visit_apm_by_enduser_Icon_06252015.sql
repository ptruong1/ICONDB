...
-- =============================================
CREATE PROCEDURE [dbo].[insert_visit_apm_by_enduser_Icon_06252015]
@FacilityID int , 
@InmateID varchar(12) , 
...
BEGIN
	...
	SET NOCOUNT ON;
	declare @currentDate as datetime, @locationID int,  @ChatServerIP varchar(30), @recordOpt varchar(1) ;
