CREATE PROCEDURE [dbo].[INSERT_PINWatchListDetailsWithAlert1]
(	
	@FacilityID int,
	@watchListID int,
	@DivisionID int,
...
AS
	...
	BEGIN
		...
		INSERT INTO [tblAlertPINs] ([PIN],[FacilityID],[AlertEmails],[AlertCellPhones],[AlertRegPhone],[HourlyFreq],[DailyFreq],[WeeklyFreq],[MonthlyFreq],[WatchListDetailID],[AlertMessage])
			   VALUES (@PIN,@FacilityID,@AlertEmails,@AlertCellPhones,@AlertRegPhone,@HourlyFreq,@DailyFreq,@WeeklyFreq,@MonthlyFreq,@ID,@AlertMessage);
		RETURN 0;
	END
