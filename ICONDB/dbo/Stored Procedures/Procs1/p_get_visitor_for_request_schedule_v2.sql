...
-- =============================================
CREATE PROCEDURE [dbo].[p_get_visitor_for_request_schedule_v2]
@FacilityID int,
@InmateID  varchar(12)
AS
BEGIN
   ...
   select b.VisitorID, (b.VFirstName + ' ' + b.VLastName) as VisitorName, (d.FirstName + d.LastName) InmateName, f.Location, c.UserName, c.Password, c.Email
