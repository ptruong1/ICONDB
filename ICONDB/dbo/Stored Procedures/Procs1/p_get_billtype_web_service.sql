CREATE PROCEDURE [dbo].[p_get_billtype_web_service]
@ANI	char(10),
@DNI	varchar(16),
@PIN		varchar(12),
@facilityID	int,
...
SET @Minduration=1
SET @i = 0 
select @timeZone =isnull( timezone,0), @CallLimit =isnull( MaxCallTime,15), @RecordOPT = isnull(RecordOPT,'Y') , @phone  = phone from tblfacility with(nolock) where facilityID =@facilityID
