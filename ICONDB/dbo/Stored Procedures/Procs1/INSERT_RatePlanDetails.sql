...
CREATE PROCEDURE [dbo].[INSERT_RatePlanDetails]
(
	@RateID varchar(5),
	@Mileagecode int,
	@DayCode varchar(2),
...
AS
	SET NOCOUNT OFF;
INSERT INTO [tblRatePlanDetail] ([RateID], [Mileagecode], [DayCode], [PointID], [TYPE], [Description], [FirstMin], [AddlMin], [CollectCallFee], [CallingCardFee], [CreditCardFee], [ThirdPartyFee], [PerToPerFee], [ACPCollectCallFee], [ACPCallingCardFee], [ACPCreditCardFee], [ACPDebitFee], [MinDuration], [MinDurationIntl], [MinIncrement], [UserName], [Inputdate], [ModifyDate]) VALUES (@RateID, @Mileagecode, @DayCode, @PointID, @TYPE, @Description, @FirstMin, @AddlMin, @CollectCallFee, @CallingCardFee, @CreditCardFee, @ThirdPartyFee, @PerToPerFee, @ACPCollectCallFee, @ACPCallingCardFee, @ACPCreditCardFee, @ACPDebitFee, @MinDuration, @MinDurationIntl, @MinIncrement, @UserName, @Inputdate, @ModifyDate);
