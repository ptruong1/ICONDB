...
CREATE PROCEDURE [dbo].[INSERT_DNIWatchListDetailsWithAlert3]
(	
	@FacilityID int,
	@watchListID int,
	@DivisionID int,
...
AS
	...
	BEGIN
        ...
        set           @ID = @nextID ; 
		INSERT INTO [tblWatchList] ([ID],[watchListID], LocationID, DivisionID, [ANI], [DNI], [PIN], [InmateID], [modifyDate], [Username], [WatchByID],[ThirdPartyAlert],[LocationTrace]) 
