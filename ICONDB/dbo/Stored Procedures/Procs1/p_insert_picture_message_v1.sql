CREATE PROCEDURE [dbo].[p_insert_picture_message_v1]  -- Family send Email to Inmate Email Box
...
Begin
	...
	INSERT tblMailboxDetail(MailBoxID ,  messageID,  MessengerNo, MessageDate , MessageName    ,  IsNew, [message], MessageTypeID,SenderMailBoxID, CCEmails, Charge,MessageStatus, MonitorOpt, DeviceName )
				values(@MailBoxID, @messageID, @AccountNo,@LocalTime,@Subject,1, @pictureName,5, @FFMailBoxID,@CCEmails,@Charge,@MessageStatus, @MonOpt, @DeviceName);
