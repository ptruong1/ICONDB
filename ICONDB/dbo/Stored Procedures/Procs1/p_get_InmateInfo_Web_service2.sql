CREATE PROCEDURE [dbo].[p_get_InmateInfo_Web_service2]
@PIN  varchar(12),
@fromNo	char(10),
@facilityID	int, 
@userName	varchar(23),
...
if(@DebitOpt =1) --- New Update if debit opt than select account
 begin
	...
	If(@DebitBalance <= 0.30 and @facilityID in (43,786,325,556,557,803,814))
		SET @DebitAcct ='0';
...
if(select count(*) from tblfacility with(nolock) where FacilityID = @facilityID and AgentID =102) > 0
	SET @DebitAcct = @PIN ;
