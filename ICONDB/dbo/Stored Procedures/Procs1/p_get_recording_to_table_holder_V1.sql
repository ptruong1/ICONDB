...
CREATE PROCEDURE [dbo].[p_get_recording_to_table_holder_V1]
...
Select RecordID, 
('\\' + UserName + '\home\ThirdPartyDetection\' + folderDate + '\' + Replace(RecordFile, '.WAV', '-out.wav')) as Inputwav,  
...
Select RecordID, 
('\\' + UserName + '\home\ThirdPartyDetection\' + folderDate + '\' + Replace(RecordFile, '.WAV', '-in.wav')) as Inputwav, 
