...
-- =============================================
CREATE PROCEDURE [dbo].[p_get_recording_to_table_holder_851_Test]
AS
BEGIN
	SELECT L.RecordID, C.FolderDate, C.userName, isnull(words,'')  as words,
TranscriptName as TranscriptionName, 
'' CalleeText, '' CallerText, '' WordsMatch, RecordFile, ComputerName as [HostName], Channel,
...
C.facilityId, I.UserName as userId
  into #temp           
...
Select RecordID,
case when  facilityId in (851, 861) then
