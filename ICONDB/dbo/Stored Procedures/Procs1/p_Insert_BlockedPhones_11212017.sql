...
CREATE PROCEDURE [dbo].[p_Insert_BlockedPhones_11212017]
(
	@PhoneNo char(10),
	@FacilityID int,
	@GroupID int,
...
Begin 
	...
	ELSE
		BEGIN
			INSERT INTO [tblBlockedPhones] ([PhoneNo], [FacilityID], [ReasonID], [Descript], [UserName], [RequestID], [TimeLimited],[inputDate], [groupID] )  VALUES (@PhoneNo, @FacilityID, @ReasonID, @Descript, @UserName, @RequestID, @Timelimited,@ActTime, @GroupID);
		END
