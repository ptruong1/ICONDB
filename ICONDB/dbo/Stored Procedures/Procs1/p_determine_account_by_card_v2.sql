...
-- =============================================
CREATE PROCEDURE [dbo].[p_determine_account_by_card_v2]
...
BEGIN
	SET NOCOUNT ON;
	Declare @AcctByCCC int, @FacilityID int, @AmountToday numeric(5,2), @AmountThisWeek numeric(5,2), @AmountThisMonth numeric(5,2), @RateplanID varchar(5) ;
    ...
    select @OrigNo	 = phone,@RateplanID=RateplanID  from tblFacility With(nolock) where FacilityID= @FacilityID;
