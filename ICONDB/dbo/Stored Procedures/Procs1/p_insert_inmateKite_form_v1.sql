...
-- =============================================
CREATE PROCEDURE [dbo].[p_insert_inmateKite_form_v1] 
		   @FacilityID int,
           @InmateID varchar(12),
           @InmateSO varchar(12),
...
If(@FormType in (1,2))
 begin
	...
	select  G.FormID,G.[FacilityID]
           ...
           ,F.[Descript] as [Status] from   tblInmateRequestForm G with(nolock)  inner join tblInmate I with(nolock)  on (G.FacilityID = I.FacilityId and G.InmateID =I.InmateID )
