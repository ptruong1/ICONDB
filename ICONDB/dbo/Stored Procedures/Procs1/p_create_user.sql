...
Insert tblUserprofiles (UserID ,  Password, FacilityID , AgentID, LastName ,  FirstName ,  MidName ,  Department , authID, Phone , Email, userLevel) 

values(@UserID,@Password  , @FacilityID , @AgentID , @LastName  ,@FirstName   ,@MidName  ,@Department  , @authID, @Phone  ,@Email,  @userLevel  )
