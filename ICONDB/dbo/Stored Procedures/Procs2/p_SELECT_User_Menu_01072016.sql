...
CREATE PROCEDURE [dbo].[p_SELECT_User_Menu_01072016]
( 
	@AuthID int
)
AS
SELECT  
	...
	,tblAuthUsers.FacilityConfig "Facility"
      ...
      ,isnull(tblAuthMonitorTab.[CallDetail], 1) "Phone Call"
      ,isnull(tblAuthMonitorTab.[VisitDetail], 1) "Face-To-Face Visit"
      ...
      ,isnull(tblAuthVideoVisitTab.[Utilities], 1) "Video Visit"
      ...
      ,isnull(tblAuthServiceRequestTab.[SearchServiceRequest], 1) "Search Service Request"
