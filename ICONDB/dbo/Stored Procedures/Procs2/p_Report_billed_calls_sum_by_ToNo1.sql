CREATE PROCEDURE [dbo].[p_Report_billed_calls_sum_by_ToNo1]
@FacilityID	int,
@AgentID	int,
...
begin
	...
	Select    toNo, 
		Count( toNo) as CallsCount, CAST(sum( CAST(duration as numeric(7,2)))/60 as Numeric(9,2)) as TotalMinutes,
