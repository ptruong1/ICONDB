...
-- =============================================
create PROCEDURE [dbo].[p_monthly_revenue_commission_by_facility_v1]
@YYMM char(4)	
AS
BEGIN
	Set Nocount On;
...
--Replenish Fee
    ...
    select a.FacilityID, a.location, a.Revenue,b.SetUpfee,c.ReplenishFee, d.CreditCardFee, (f.CallRevenue * isnull(f.CommRate,0)) Commission   
    from @Revenue a 
	...
	--select a.FacilityID, a.location, a.Revenue,b.SetUpfee,c.ReplenishFee, d.CreditCardFee, (f.CallRevenue * isnull(f.CommRate,0)) Commission   
	--from  @Revenue  a,  @SetupFee b,  @ReplenishFee c, @CreditCardFee d ,  @Commision f
