CREATE PROCEDURE [dbo].[p_Report_billed_calls_sum_by_Calltype1]
@FacilityID	int,
@AgentID	int,
...
Begin
	...
	Select   tblCalltype.Descript  as CallType
		,  Count(tblcallsBilled.Calltype) as CallsCount, CAST(sum( CAST(duration as numeric(7,2)))/60 as Numeric(9,2)) as TotalMinutes,
