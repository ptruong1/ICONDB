...
-- =============================================
CREATE PROCEDURE [dbo].[p_select_available_appointment_by_admin_v1_test]
	@facilityID	int,
	@locationID int,
	@InmateID	varchar(12),
	@scheduleDate	date,
...
BEGIN
	...
	SET NOCOUNT ON;
	Declare @period smallint, @hour tinyint, @minute tinyint, @year smallint, @AppPerPeriod smallint,@month tinyint,@InterApm int,@flatform tinyint, @LocationName varchar(30),@MaxTimevisit smallint, @MaxFTime smallint, @MaxInmateTime smallint ,  @MinTimeVisit smallint;
   ...
   Declare @return_value smallint;
	...
	if(@CurrentDate < @scheduleDate)
		select  ScheduleTime,@MinTimeVisit as ApmTimeMin,  @period  -@InterApm  as ApmTimeLimit,@ApmIncrement as ApmIncrement, @RecordOpt as  RecordOpt 
