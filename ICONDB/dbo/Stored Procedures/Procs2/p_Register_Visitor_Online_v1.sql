...
CREATE PROCEDURE [dbo].[p_Register_Visitor_Online_v1]
(
...
SELECT @recordOpt = isnull(RecordOpt,'Y'),@VisitRegReq= isnull( VisitRegReq,0)   from  [tblVisitFacilityConfig] with(nolock) where facilityID = @facilityID ;
