CREATE PROCEDURE [dbo].[p_reply_email_message_by_inmate_v1]  -- Family send Email to Inmate Email Box
@MailBoxID bigint,
@MessageID	bigint,
...
Begin
	...
	INSERT tblMailboxDetailF(MailBoxID ,  messageID,   MessageDate , MessageName    ,  IsNew, [message], MessageTypeID,SenderMailBoxID, Email,IsReply,MessageStatus,Charge, MonitorOpt, DeviceName )
				values(@SenderMailBoxID, @ReplyMessageID, @LocalTime,@messageName,1, @Message,2,@MailBoxID,@Email,1,@MessageStatus,0, @MonOpt, @DeviceName);
	return @@error;
End;
