...
-- =============================================
CREATE PROCEDURE [dbo].[p_search_inmate_activity_v4]
@FacilityID int,
@InmateID	varchar(12),
 ...
 begin
		if(@FirstName <> '' and @LastName <>''   and @FromDate <>'' and @todate<>'' )
		 ...
		 begin
			...
			insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType, StationID , ContactPhone,PhoneType , Duration, CommStatus, RecordOpt ) 
				select isnull(RecordID,0), InmateID, RecordDate, 1, fromNo,tono,(CASE ResponseCode when '399' then 2 when '010' then 1 else 3 end), 0, errorType, 'N' from tblcallsUnbilled with(nolock)  where facilityID = @facilityID and RecordDate>=@FromDate and RecordDate <=dateadd(d,1,@toDate); 	   
			insert  @InmateAct  (RecordID , InmateID ,InmateName, ActivityDate, CommunityType,  StationID , ContactPhone , Duration, CommStatus,RecordOpt ) 
	...
	if(@FromDate <>'' and @todate<>'') 
	 begin
	    insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType, StationID , ContactPhone,PhoneType , Duration, CommStatus,RecordOpt ) 
		 ...
		 insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType,  StationID , ContactPhone,PhoneType , Duration, CommStatus, RecordOpt ) 
			select isnull(RecordID,0), InmateID, RecordDate, 1, fromNo,tono,(CASE ResponseCode when '399' then 2 when '010' then 1 else 3 end), 0, errorType, 'N' from tblcallsUnbilled with(nolock)  where facilityID = @facilityID and InmateID =@InmateID and RecordDate>=@FromDate and RecordDate <= dateadd(d,1,@toDate); 	   
		insert  @InmateAct  (RecordID , InmateID ,InmateName, ActivityDate, CommunityType,  StationID , ContactPhone , Duration, CommStatus,RecordOpt ) 
	 ...
	 begin
	    insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType, StationID , ContactPhone,PhoneType , Duration, CommStatus,RecordOpt ) 
		 ...
		 insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType,  StationID , ContactPhone,PhoneType , Duration, CommStatus, RecordOpt ) 
			select isnull(RecordID,0), InmateID, RecordDate, 1, fromNo,tono,(CASE ResponseCode when '399' then 2 when '010' then 1 else 3 end), 0, errorType, 'N' from tblcallsUnbilled with(nolock)  where facilityID = @facilityID and InmateID =@InmateID  and RecordDate>=@FromDate ; 	   
		insert  @InmateAct  (RecordID , InmateID ,InmateName, ActivityDate, CommunityType,  StationID , ContactPhone , Duration, CommStatus,RecordOpt ) 
	 ...
	 begin
	    insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType, StationID , ContactPhone,PhoneType , Duration, CommStatus,RecordOpt ) 
		 ...
		 insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType,  StationID , ContactPhone,PhoneType , Duration, CommStatus, RecordOpt ) 
			select isnull(RecordID,0), InmateID, RecordDate, 1, fromNo,tono,(CASE ResponseCode when '399' then 2 when '010' then 1 else 3 end), 0, errorType, 'N' from tblcallsUnbilled with(nolock)  where facilityID = @facilityID and InmateID =@InmateID  and  RecordDate <=dateadd(d,1,@toDate); 	   
		insert  @InmateAct  (RecordID , InmateID ,InmateName, ActivityDate, CommunityType,  StationID , ContactPhone , Duration, CommStatus,RecordOpt ) 
	 ...
	 begin
	    insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType, StationID , ContactPhone,PhoneType , Duration, CommStatus,RecordOpt ) 
		 ...
		 insert  @InmateAct  (RecordID , InmateID , ActivityDate, CommunityType,  StationID , ContactPhone,PhoneType , Duration, CommStatus, RecordOpt ) 
			select isnull(RecordID,0), InmateID, RecordDate, 1, fromNo,tono,(CASE ResponseCode when '399' then 2 when '010' then 1 else 3 end), 0, errorType, 'N' from tblcallsUnbilled with(nolock) where facilityID = @facilityID and InmateID = @InmateID;	   
		insert  @InmateAct  (RecordID , InmateID ,InmateName, ActivityDate, CommunityType,  StationID , ContactPhone , Duration, CommStatus,RecordOpt ) 
