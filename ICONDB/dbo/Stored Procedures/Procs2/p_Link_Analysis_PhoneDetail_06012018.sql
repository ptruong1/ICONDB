...
create PROCEDURE [dbo].[p_Link_Analysis_PhoneDetail_06012018]
@FacilityID	int,
...
duration varchar(8) Null,  CallCount smallint, linkcount int, TransRecordId varchar(12), UserLanguage Varchar(40))
...
('P' + 
		...
		(select callCount from @Temp4 a where a.toNo = b.toNo), Phcount,'', '' as userlanguage
