...
-- =============================================
CREATE PROCEDURE [dbo].[p_select_available_appointment_2]  --------------------Schedule from prepaid side
	@facilityID	int,
	@locationID int,
	@InmateID	varchar(12),
...
BEGIN
	...
	Declare @MaxTimevisit smallint, @LocLimitTime smallint, @InmateLimitTime smallint,@DayLimitTime smallint, @RelationShipID tinyint, @ExtID varchar(15), @Atlocation varchar(30);
	...
	Declare @return_value smallint, @Gender varchar(1), @ApmTimeLimit int, @CurrentDate Date;
	...
	SET @timezone = (select timezone from leg_Icon.dbo.tblfacility with(nolock) where FacilityID =@facilityID) ;   
