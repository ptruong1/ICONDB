...
-- =============================================
CREATE PROCEDURE [dbo].[p_select_available_appointment_140604]
	@facilityID	int,
	@locationID int,
	@InmateID	varchar(12),
...
BEGIN
   ...
   ---------- Add Cell Schedule and Location Schedule
	...
	from @tempSchedule where CurrentApm < @NumOfStations and DATEADD(MI,DATEPART(HOUR ,ScheduleTime) *60 +   DATEPART(MI ,ScheduleTime), ScheduleDate) >= DATEADD(Hour,@hourbeforevisit, @localTime) 
