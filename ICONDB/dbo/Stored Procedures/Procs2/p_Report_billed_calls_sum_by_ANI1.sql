CREATE PROCEDURE [dbo].[p_Report_billed_calls_sum_by_ANI1]
@FacilityID	int,
@AgentID	int,
...
Begin
	Select    FromNo,  StationID
		,  Count( FromNo) as CallsCount, CAST(sum( CAST(duration as numeric(7,2)))/60 as Numeric(9,2)) as TotalMinutes,
