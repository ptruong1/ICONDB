...
CREATE PROCEDURE  [dbo].[p_user_Icon5_login4]
@userName  varchar(20),
@password	varchar(20),
...
Else 
 Begin
	...
	SET @loginID = @@identity ;
	select 0 as FacilityID,'Legacy' as  Location ,'Valley View'  Address1,'Cypress'  City, 'CA' as State,'714-826-0547' Phone , ''  as Logo ,0  as PINRequired, 0 as  AgentID,0 as GroupID,  @loginID as LoginID ,@userLevel as  userLevel  ,
