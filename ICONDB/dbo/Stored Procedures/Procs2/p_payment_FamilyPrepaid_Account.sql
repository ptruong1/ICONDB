...
CREATE PROCEDURE [dbo].[p_payment_FamilyPrepaid_Account]
...
Declare @return_value int, @nextID bigint, @ID bigint, @tblTransactionLogs nvarchar(32),@tblpurchase nvarchar(32),@tblWUPrepaid nvarchar(32);
