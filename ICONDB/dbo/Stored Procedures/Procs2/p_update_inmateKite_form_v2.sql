...
-- =============================================
CREATE PROCEDURE [dbo].[p_update_inmateKite_form_v2] 
		   @FacilityID int,
           @FormID int,
           @Status tinyint
...
select  G.[FormID]
	  ...
	  ,G.[FormType] from tblInmateRequestForm G inner join tblInmate  I on (G.FacilityID = I.FacilityId and G.InmateID =I.InmateID )
