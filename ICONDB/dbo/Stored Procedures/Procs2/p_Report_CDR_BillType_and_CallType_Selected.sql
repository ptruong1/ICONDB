CREATE PROCEDURE [dbo].[p_Report_CDR_BillType_and_CallType_Selected]
...
ConnectDateTime datetime,	 CallingCard	varchar(12),
			PIN varchar(12), Fname	varchar(25), LName varchar(25), BillType  varchar(25), CallType  varchar(25), State varchar(25), Duration 
