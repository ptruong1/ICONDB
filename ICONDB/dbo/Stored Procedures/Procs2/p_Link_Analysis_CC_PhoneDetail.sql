...
CREATE PROCEDURE [dbo].[p_Link_Analysis_CC_PhoneDetail]
@FacilityID	int,
...
Select distinct 2, '', '', a.cNum, 
		  ...
		  '', '' Fname, '' LName, '' RecordId, '' ConnectDateTime, '' RecordFile, 0 duration, b.ccTotal, b.LinkCount, '', '' cNum, '' Vfname, '' VLname, '' InmateId
...
('P' + 
		...
		b.LinkCount,'', '' cNum, '' Vfname, '' VLname, '' InmateId
