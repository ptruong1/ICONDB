...
Create PROCEDURE [dbo].[p_Link_Analysis_InmateDetail_05302018]
@FacilityID	int,
...
FromNo varchar(12), Fname varchar(25), Lname varchar(25), RecordId varchar(12), ConnectDateTime datetime, RecordFile varchar(20),  Duration varchar(8) Null,  CallCount smallint, linkcount int, TransRecordId varchar(12))
...
Select distinct 1,InmateID, toNo,  '', '', '' fromNo, '' Fname, '' LName, '' RecordId, '' ConnectDateTime, '' RecordFile, 0 duration, CallCount, LinkCount,''
from @Temp3
...
('P' + 
		...
		'' fromNo, '' Fname, '' LName, '' RecordId, '' ConnectDateTime, '' RecordFile, 0 duration, (select top 1 callCount from @Temp4 a where a.toNo = b.toNo), Phcount,''
