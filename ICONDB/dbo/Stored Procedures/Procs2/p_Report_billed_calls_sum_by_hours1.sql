CREATE PROCEDURE [dbo].[p_Report_billed_calls_sum_by_hours1]
@FacilityID	int,
@AgentID	int,
...
begin
	...
	Select    CallDate ,Left(ConnectTime,2) as [Hour],  Count(Left(CallDate,2) ) as CallsCount, CAST(sum( CAST(duration as numeric(7,2)))/60 as Numeric(9,2)) as TotalMinutes , 
