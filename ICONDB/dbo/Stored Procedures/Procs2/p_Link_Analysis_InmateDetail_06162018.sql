...
CREATE PROCEDURE [dbo].[p_Link_Analysis_InmateDetail_06162018]
@FacilityID	int,
...
CallCount smallint, linkcount int, TransRecordId varchar(12), UserLanguage Varchar(40), VFname varchar(25), VLname varchar(30))
...
Select distinct 1,InmateID, toNo,  '', '', '' fromNo, '' Fname, '' LName, '' RecordId, '' ConnectDateTime, '' RecordFile, 0 duration, 
...
('P' + 
		...
		(select top 1 callCount from @Temp4 a where a.toNo = b.toNo), Phcount,'', '' userlanguage, '' VFname, '' VLname  
