...
-- =============================================
CREATE PROCEDURE [dbo].[p_update_medicalKite_form_v1]
			@FacilityID  int,
            @FormID int,
            @Status tinyint
...
BEGIN
	...
	select 
      ...
      ,G.[Status] as [StatusID]      
		   ...
		   G.[Copay],
		   G.[VisitedClinic] 
		   from [tblMedicalKiteForm] G inner join tblInmate  I on (G.FacilityID = I.FacilityId and G.InmateID =I.InmateID )
