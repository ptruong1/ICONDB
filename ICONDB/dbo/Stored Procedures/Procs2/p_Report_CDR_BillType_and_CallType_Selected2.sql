CREATE PROCEDURE [dbo].[p_Report_CDR_BillType_and_CallType_Selected2]
...
numeric(5,2), CallRevenue  numeric(5,2), Descript varchar(25), RecordFile varchar(20), DOB varchar(12), Sex varchar(15), Race varchar(25))
...
Duration,CallRevenue, Descript, RecordFile, DOB, Sex, Race )
...
RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race   
		from tblcallsUnbilled with(nolock), tblBilltype with(nolock), tblInmate with(nolock) ,tblANIs with(nolock) ,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) , 
tblErrortype  with(nolock) , tblCallType with(nolock)
  ...
  DebitCardNo, tblincidentreport.InmateID, LastName ,  FirstName,   'CTS'  as BillType,
			 'RTS' as CallType ,    'Call To Staff'      as     state ,  '0' as Duration, 0 as  CallRevenue, '3' as Descript, 'UnK' as RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race 
...
Descript, RecordFile, DOB, Sex, Race    from  #tempCDR   WHERE   RecordIDs >= @startRowIndex
...
CAST(duration as numeric(7,2))/60 as Numeric(9,2)) as Duration, CallRevenue, tblPhoneTypes.Descript as Descript, RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
		  from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs 
		with(nolock) ,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) 
...
ConnectDateTime   ,''  DebitCardNo, tblincidentreport.InmateID, LastName ,  FirstName,   'CTS'  as BillType,
			 'RTS' as CallType ,    'Call To Staff'      as     state ,  '0' as Duration, 0 as  CallRevenue, '3' as Descript, 
			 'UnK' as RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race 
			 FROM  tblincidentreport with(nolock) , tblInmate with(nolock)  	,tblANIs with(nolock), tblRaces with(nolock), tblSex with(nolock)  
			 WHERE ANI = tblANIs.ANINo and tblincidentreport.InmateID = tblInmate.InmateID and
				isnull(tblInmate.RaceID, 0) = tblRaces.RaceID  and isnull(tblInmate.Sex,'U') = tblSex.Sex and
				tblincidentreport.FacilityID = @FacilityID and tblincidentreport.InputDate  >= @FromDate  
...
Descript, RecordFile, DOB, Sex, Race    from  #tempCDR   WHERE   RecordIDs >= @startRowIndex
	...
	Else If @FName <> ''  ------- 04/25/2011 ----
		...
		State , Duration,CallRevenue, Descript, RecordFile, DOB, Sex, Race ) 
		Select  left( tblANIs.StationID,20) PhoneID, RecordID , toNo,   DATEADD(second, - duration, recordDate) as startTime, RecordDate as  
...
ConnectDateTime ,(case   
		...
		tblBilltype.Descript  as  BillType, tblCallType.Descript  as  CallType , 'Completed' as  State,
			CAST( CAST(duration as numeric(7,2))/60 as Numeric(9,2)) as Duration, CallRevenue, tblPhoneTypes.Descript as Descript , RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
  		 from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs with(nolock) 
		,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) 
		  where  tblcallsBilled.fromno = tblANIs.ANINo and
			 tblcallsBilled.InmateID  = tblInmate.InmateID and
...
ConnectDateTime   ,''  DebitCardNo, tblincidentreport.InmateID, LastName ,  FirstName,   'CTS'  as BillType,
		...
		Duration,CallRevenue, Descript, RecordFile, DOB, Sex,  Race    from  #tempCDR   WHERE   RecordIDs >= @startRowIndex
...
ConnectDateTime ,(case   
		...
		tblBilltype.Descript  as  BillType, tblCallType.Descript  as  CallType , 'Completed' as  State,
			...
			DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
   		from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs with(nolock) 
		,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) 
		  where  tblcallsBilled.fromno = tblANIs.ANINo and
			 tblcallsBilled.InmateID  = tblInmate.InmateID and
		...
		Select  left( tblANIs.StationID,20) PhoneID, 0 as RecordID, toNo, RecordDate as StartTime, RecordDate as 
ConnectDateTime, DebitCardNo,  tblcallsUnbilled.InmateID,  FirstName, LastName ,   tblBilltype.Descript  as  BillType,
			tblCallType.Descript  as CallType,tblErrortype.Descript as  State,'0'  as Duration,0, tblPhoneTypes.Descript as Descript ,
			 'UnK' as RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race   
		from tblcallsUnbilled with(nolock), tblBilltype with(nolock), tblInmate with(nolock) ,tblANIs with(nolock) ,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) , 
tblErrortype  with(nolock) , tblCallType with(nolock)
		 where   isnull( tblcallsUnBilled.CallType ,'NA' )= tblCalltype.Abrev and 
...
ConnectDateTime ,(case  tblcallsBilled.Billtype when '07' then left(CreditcardNo,12) else '' end )  DebitCardNo,  tblcallsBilled.InmateID,  FirstName, LastName ,  
		...
		tblBilltype.Descript  as  BillType, tblCallType.Descript  as  CallType , 'Completed' as  State, CAST( CAST(duration as numeric(7,2))/60 as 
Numeric(9,2)) as Duration, CallRevenue, tblPhoneTypes.Descript as Descript , RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
  		 from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs with(nolock), tblRaces with(nolock), tblSex with(nolock) 
...
ConnectDateTime ,  (case   tblcallsBilled.Billtype when '07' then left(CreditcardNo,12) else '' end )  DebitCardNo, 
		 tblcallsBilled.InmateID,  FirstName, LastName ,   tblBilltype.Descript  as  BillType, tblCallType.Descript  as  CallType , 'Completed' as  
State,CAST( CAST(duration as numeric(7,2))/60 as Numeric(9,2)) as Duration, CallRevenue, tblPhoneTypes.Descript as Descript, RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
		    from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs with(nolock) 
,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) 
		 where  tblcallsBilled.fromno =  tblANIs.ANINo and
			 tblcallsBilled.InmateID  = tblInmate.InmateID and
...
RecordFile, DOB, Sex,  Race    from  #tempCDR 
...
numeric(7,2))/60 as Numeric(9,2)) as Duration, CallRevenue, tblPhoneTypes.Descript as Descript , RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
 		  from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs with(nolock) 
,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) 
		 where  tblcallsBilled.fromno = tblANIs.ANINo and
			 tblcallsBilled.InmateID  = tblInmate.InmateID and
...
CallRevenue, tblPhoneTypes.Descript as Descript , RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race
 		  from tblcallsBilled with(nolock)  ,  tblBilltype with(nolock), tblCallType with(nolock) ,tblInmate with(nolock) ,tblANIs with(nolock) 
,tblPhonetypes with(nolock), tblRaces with(nolock), tblSex with(nolock) 
		  where  tblcallsBilled.fromno = tblANIs.ANINo and
			 tblcallsBilled.InmateID  = tblInmate.InmateID and
...
ConnectDateTime      ,''  DebitCardNo, tblincidentreport.InmateID, LastName ,  FirstName,   'CTS'  as BillType,
		...
		select   RecordID, PhoneID , toNo , StartTime, ConnectDateTime , CallingCard,InmateID,  Fname, LName ,  BillType, CallType  ,  State , Duration,CallRevenue, 
Descript, RecordFile, DOB, tblSex.Descript as Sex,  Race    from  #tempCDR   WHERE   RecordIDs >= @startRowIndex
...
'UnK' as RecordFile, DOB, tblSex.Descript as Sex, tblRaces.Descript as Race  from tblincidentreport with(nolock) , tblInmate with(nolock)  ,tblANIs with(nolock), tblRaces with(nolock), tblSex with(nolock)  
