...
CREATE PROCEDURE [dbo].[p_Report_Tax_Billed_01182017]
...
SELECT tblTaxesBilled.State,TaxingJurisName,tblBilltype.Descript as BillType, 1 as CallCounts,[BilledRevenue], [FedTax],[StateTax],[LocalTax],[BilledDate],[BilledStatus],
