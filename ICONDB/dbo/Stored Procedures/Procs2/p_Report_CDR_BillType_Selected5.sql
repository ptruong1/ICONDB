CREATE PROCEDURE [dbo].[p_Report_CDR_BillType_Selected5]
@FacilityID	int,
@divisionID	int,
@locationID	int,
@phoneID	varchar(100),
...
tblBilltype.Descript  as  BillType, tblCallType.Descript  as  CallType , 'Completed' as  State,
			CAST( CAST(duration as numeric(7,2))/60 as Numeric(9,2)) as Duration, CallRevenue, tblPhoneTypes.Descript as Descript 
...
as  State,'0'  as Duration,0, tblPhoneTypes.Descript as Descript    from tblcallsUnbilled with(nolock), tblBilltype with(nolock), tblInmate with(nolock) ,tblANIs with(nolock) ,tblPhonetypes with(nolock) , tblErrortype  with(nolock)
...
,
			  '0' as Duration, 0 as  CallRevenue, '3' as Descript  from tblincidentreport with(nolock) , tblInmate with(nolock)  
,tblANIs with(nolock)  
...
tblcallsUnbilled.PIN,  FirstName, LastName ,   tblBilltype.Descript  as  BillType, 'Unknown' as CallType,tblErrortype.Descript 
as  State,
			 '0'  as Duration,0, tblPhoneTypes.Descript as Descript    from tblcallsUnbilled with(nolock)  ,  tblBilltype 
