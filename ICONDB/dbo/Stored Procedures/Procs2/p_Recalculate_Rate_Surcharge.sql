...
CREATE PROCEDURE [dbo].[p_Recalculate_Rate_Surcharge]
@ANI  varchar(10),
@DNI	varchar(20),
@trunk  varchar(6),
@FacilityID	int,
...
@PIN	varchar(12),
@userName	varchar(23),
@firstMinute   numeric(6,2)  OUTPUT,
@nextMinute   numeric(6,2)  OUTPUT,
@connectFee numeric(6,2)  OUTPUT,
...
@PIP		Numeric(6,2) OUTPUT, -- this is total surcharges
...
Declare   @ANI_Horizontal   numeric(8,2), @ANI_vertical  numeric(8,2),  @DNI_Horizontal   numeric(8,2), @DNI_vertical  numeric(8,2) ,  @Mileage INT, @i int 
...
Else   
 ...
 Begin
	If(@billtype ='07'  Or   @billtype ='10'   Or  @billtype ='05'   Or  @billtype ='03'   )
