...
CREATE PROCEDURE [dbo].[p_update_Facility_LegacySite09052018]
(
	@Location varchar(50),
	@Address varchar(50),
	@City varchar(20),
	...
	@AcctRepID tinyint,
	@RecordOpt varchar(1),
	@VisitContactEmail1 varchar(50),
	@VisitContactEmail2 varchar(50),
	@VisitContactEmail3 varchar(50)
)
AS
...
ELSE
	BEGIN		
		...
		UPDATE tblVisitFacilityConfig set ContactEmail =@VisitContactEmail1,
										  contactemail2 =@VisitContactEmail2,
										  contactemail3 =@VisitContactEmail3
