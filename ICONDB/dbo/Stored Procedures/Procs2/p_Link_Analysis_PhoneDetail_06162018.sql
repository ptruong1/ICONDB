...
create PROCEDURE [dbo].[p_Link_Analysis_PhoneDetail_06162018]
@FacilityID	int,
...
duration varchar(8) Null,  CallCount smallint, linkcount int, TransRecordId varchar(12), UserLanguage Varchar(40), VFname varchar(25), VLname varchar(30))
...
CallCount, linkcount,TransRecordId, userLanguage, VFname, VLname )
Select distinct 1, toNo, InmateID, '', '', '' fromNo, '' Fname, '' LName, '' RecordId, '' ConnectDateTime, '' RecordFile, 0 duration, 
CallCount, LinkCount,'', '' as userLanguage, '' VFname, '' VLname
from @Temp3
...
Select distinct 2, '', '', a.InmateID, 
		  ...
		  '', Fname, LName, '' RecordId, '' ConnectDateTime, '' RecordFile, 0 duration, totalcount,inmatecount,'', '' as userlanguage, '' VFname, '' VLname
 ...
 RecordFile, duration,CallCount,linkcount, TransRecordId, userlanguage, VFname, VLname)
...
('P' + 
		...
		(select callCount from @Temp4 a where a.toNo = b.toNo), Phcount,'', '' as userlanguage, '' VFname, '' VLname
...
duration, CallCount, linkcount,TransRecordId, userLanguage, VFname, VLname)
