CREATE PROCEDURE [dbo].[p_Report_Billed_Calls_Detail_SNo1_Test]
...
If (@AgentId >1 AND @facilityID =0 ) and (select count(*) from tblBadDebt with(nolock) where  AgentID = @AgentID and tblBadDebt.FacilityID = @divisionID) > 0 
Begin
