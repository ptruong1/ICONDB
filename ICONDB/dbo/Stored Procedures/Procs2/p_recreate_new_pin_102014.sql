...
-- =============================================
CREATE PROCEDURE [dbo].[p_recreate_new_pin_102014]
	@facilityID int,
	@InmateID varchar(12),
...
BEGIN
	...
	UPDATE tblInmate set PIN =@newPIN where FacilityId =@facilityID and InmateID =@OrigInmateID and PIN =@currentPIN;
