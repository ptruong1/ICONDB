...
-- =============================================
CREATE PROCEDURE [dbo].[p_select_available_appointment_by_facility]
	@facilityID	int,
	@locationID int,
	@InmateID	varchar(12),
...
BEGIN
	If (@facilityID = 607) --- only dona use this one
		...
		exec p_select_available_appointment_by_admin_v1 @facilityID, @locationID, 	@InmateID, 	@scheduleDate, 	@VisitorID;
END
